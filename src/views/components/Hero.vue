      ...
      <div class="col px-0">
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-7 text-center pt-lg">
            <img
              src="img/brand/quark_white.png"
              id="quark_img"
              style="width: 400px;"
              class="img-fluid"
            />
            <!-- <base-button class="btn-1" type="success">Success</base-button> -->
            <p class="lead text-white mt-4 mb-5">Fest Under Contruction</p>
            <div class="btn-wrapper">
              <base-button
                tag="a"
                href="https://www.youtube.com/channel/UCqtrSV1VbseY2GPC0HhJphA"
                class="mb-3 mb-sm-0"
                type="info"
                icon="fa fa-code"
              >Explore quark</base-button>
              <base-button
                tag="a"
                href
                class="mb-3 mb-sm-0"
              ...
              >Download Something</base-button>
            </div>
          </div>
        </div>
